...
#SBATCH --job-name=zyda  ## When you run squeue -u NETID this is how you can identify the job
#SBATCH --mail-user=nicholas.hagar@northwestern.edu
#SBATCH --mail-type=ALL

module purge all

uv run derived_dataset_pipeline.py --dataset zyphra/zyda --variant default --batch-size 500_000_000_000 --num-proc 16 --cache-dir /scratch/nrh146/cache-zyda