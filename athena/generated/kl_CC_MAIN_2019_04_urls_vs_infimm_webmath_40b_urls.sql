...
WITH p_base AS (
    ...
    FROM
        cc
    WHERE
        dataset_name IN ('CC-MAIN-2019-04_urls','CC-MAIN-2019-09_urls','CC-MAIN-2019-13_urls','CC-MAIN-2019-18_urls','CC-MAIN-2019-22_urls','CC-MAIN-2019-26_urls','CC-MAIN-2019-30_urls','CC-MAIN-2019-35_urls','CC-MAIN-2019-39_urls','CC-MAIN-2019-43_urls','CC-MAIN-2019-47_urls','CC-MAIN-2019-51_urls','CC-MAIN-2020-05_urls','CC-MAIN-2020-10_urls','CC-MAIN-2020-16_urls','CC-MAIN-2020-24_urls','CC-MAIN-2020-29_urls','CC-MAIN-2020-34_urls','CC-MAIN-2020-40_urls','CC-MAIN-2020-50_urls','CC-MAIN-2021-04_urls','CC-MAIN-2021-10_urls','CC-MAIN-2021-17_urls','CC-MAIN-2021-21_urls','CC-MAIN-2021-25_urls','CC-MAIN-2021-31_urls','CC-MAIN-2021-39_urls','CC-MAIN-2021-43_urls','CC-MAIN-2021-49_urls','CC-MAIN-2022-05_urls','CC-MAIN-2022-21_urls','CC-MAIN-2022-27_urls','CC-MAIN-2022-33_urls','CC-MAIN-2022-40_urls','CC-MAIN-2022-49_urls','CC-MAIN-2023-06_urls','CC-MAIN-2023-14_urls','CC-MAIN-2023-23_urls','CC-MAIN-2023-40_urls','CC-MAIN-2023-50_urls')
    GROUP BY
        url_host_name
),
p_total AS (
...
WITH q_base AS (
    ...
    FROM
        hf_data
    WHERE
        dataset_name IN ('infimm-webmath-40b_urls')
    GROUP BY
        domain
),
q_total AS (
