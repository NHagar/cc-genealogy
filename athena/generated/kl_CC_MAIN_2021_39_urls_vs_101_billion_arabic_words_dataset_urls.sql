...
WITH p_base AS (
    ...
    FROM
        cc
    WHERE
        dataset_name IN ('CC-MAIN-2021-39_urls','CC-MAIN-2021-43_urls','CC-MAIN-2021-49_urls','CC-MAIN-2022-05_urls','CC-MAIN-2022-21_urls','CC-MAIN-2022-27_urls')
    GROUP BY
        url_host_name
),
p_total AS (
...
WITH q_base AS (
    ...
    FROM
        hf_data
    WHERE
        dataset_name IN ('101_billion_arabic_words_dataset_urls')
    GROUP BY
        domain
),
q_total AS (
